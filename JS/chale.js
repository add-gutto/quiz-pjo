...
export const chales = [
    ...
    new Chale("Hefesto",
        ...
        [1, 4, 1, 5, 5, 6, 2, 5, 3, 2, 6, 6, 6, 5, 4, 5, 6, 2, 3, 3, 3, 2, 5, 5, 3, 3, 4, 6, 1, 1, 2, 1, 6, 5, 6, 1, 1, 4, 3, 4, 2, 2, 2, 6, 5, 5, 2, 5, 5, 4, 3, 4, 5, 5, 6], "MEDIA/Zeus.webp"),
    new Chale("Afrodite",
        "Beleza sobrenatural, persuasão encantadora (charme), empatia emocional e, às vezes, manipulação de desejos.",
        [4, 3, 5, 3, 2, 3, 4, 2, 5, 3, 2, 1, 2, 4, 2, 1, 1, 3, 4, 3, 5, 5, 2, 6, 3, 5, 3, 2, 3, 5, 5, 5, 1, 3, 2, 4, 5, 2, 5, 5, 5, 5, 2, 4, 4, 3, 5, 1, 1, 1, 6, 4, 2, 3, 2], "MEDIA/Zeus.webp"),
    new Chale("Hermes",
        ...
        [4, 5, 2, 6, 4, 7, 7, 2, 2, 4, 3, 5, 3, 1, 3, 2, 3, 3, 5, 5, 7, 4, 1, 3, 4, 2, 4, 5, 6, 4, 5, 6, 3, 2, 2, 1, 2, 4, 2, 7, 1, 7, 5, 4, 4, 2, 3, 3, 4, 4, 4, 3, 3, 2, 2], "MEDIA/Zeus.webp"),
    new Chale("Dionisio",
        "Manipulação de vinhas e plantas, indução de loucura ou êxtase e resistência a toxinas.",
        [6, 5, 3, 7, 2, 6, 6, 1, 4, 6, 2, 6, 6, 4, 1, 3, 2, 7, 2, 5, 6, 1, 3, 2, 2, 6, 6, 4, 6, 1, 2, 7, 2, 1, 1, 5, 1, 3, 1, 5, 5, 7, 5, 6, 3, 1, 7, 2, 4, 7, 1, 6, 2, 1, 3], "MEDIA/Zeus.webp"),
    new Chale("Hades",
        "Controle sobre sombras, mortos e minerais preciosos; podem invocar esqueletos e acessar o poder do submundo.",
        [2, 6, 3, 2, 1, 4, 3, 6, 1, 1, 5, 4, 5, 6, 4, 4, 7, 6, 1, 4, 2, 3, 4, 1, 1, 5, 4, 2, 1, 2, 1, 5, 6, 7, 6, 3, 4, 2, 5, 2, 7, 3, 3, 2, 2, 7, 1, 6, 3, 2, 1, 2, 1, 3, 1], "MEDIA/Zeus.webp"),
