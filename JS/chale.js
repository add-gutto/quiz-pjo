...
export const chales = [
    ...
    new Chale("Poseidon",
        ...
        [5, 4, 2, 2, 4, 2, 5, 3, 5, 6, 4, 4, 2, 1, 5, 6, 1, 5, 6, 2, 1, 6, 6, 5, 2, 3, 5, 1, 1, 7, 4, 4, 2, 4, 3, 5, 7, 3, 7, 6, 1, 1, 3, 5, 3, 6, 6, 2, 5, 6, 1, 1, 6, 4, 3], "MEDIA/Poseidon.jpeg"),
    new Chale("Demeter",
    ...
    new Chale("Hermes",
        ...
        [4, 5, 2, 6, 4, 7, 7, 2, 2, 4, 3, 5, 3, 1, 3, 2, 3, 3, 5, 5, 7, 4, 1, 3, 4, 2, 4, 5, 6, 4, 5, 6, 3, 2, 2, 1, 2, 4, 2, 7, 1, 7, 5, 4, 4, 2, 3, 3, 4, 4, 4, 3, 3, 2, 2], "MEDIA/Hermes.jpeg"),
    new Chale("Dionisio",
        "Manipulação de vinhas e plantas, indução de loucura ou êxtase e resistência a toxinas.",
        [6, 5, 3, 7, 2, 6, 6, 1, 4, 6, 2, 6, 6, 4, 1, 3, 2, 7, 2, 5, 6, 1, 3, 2, 2, 6, 6, 4, 6, 1, 2, 7, 2, 1, 1, 5, 1, 3, 1, 5, 5, 7, 5, 6, 3, 1, 7, 2, 4, 7, 1, 6, 2, 1, 3], "MEDIA/Dionisio.jpeg"),
    new Chale("Hades",
